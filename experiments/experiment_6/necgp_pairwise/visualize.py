"""[necgp_pairwise copy of `necgp/visualize.py`, 2026-09-14; adds `stage_grid(mod_colour=)`.]
...
def stage_grid(panels, gates, n_in: int, save_path, title: str = "",
               ...
               rows: int = STAGE_ROWS, cols: int = STAGE_COLS,
    ...
    shared: dict[str, str] = {} if mod_colour is None else mod_colour
    fits = []
