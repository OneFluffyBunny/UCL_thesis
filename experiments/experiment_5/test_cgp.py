...
def test_ka_task_counts() -> None:
    ...
    (t_and,) = tasks_mod.target_masks("retina_ka2005", "and")
    (t_or,) = tasks_mod.target_masks("retina_ka2005", "or")
    (t_xor,) = tasks_mod.target_masks("retina_ka2005", "xor")
...
def test_one_half_predictor_is_capped() -> None:
    ...
    n_patterns = tasks_mod.n_patterns("retina_ka2005")
    (left,) = tasks_mod.target_masks("left")               # L over 16 patterns
    ...
    for op, const in (("and", 0), ("or", mask)):
        t = tasks_mod.target_masks("retina_ka2005", op)
